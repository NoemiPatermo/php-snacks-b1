...
*/
$testo = "Lorem Ipsum è un testo segnaposto utilizzato nel settore della tipografia e della stampa. 
...
$arrayTesto = explode(".", $testo); //creato array per applicare explode

for ($i=0; $i < count($arrayTesto) ; $i++) { 
    echo "<p>".$arrayTesto[$i].".</p>";
}
